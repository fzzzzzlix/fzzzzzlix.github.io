  ...
  return (
    <div className="site-frame">
      ...
      <main id="main-content">
        <PageHero eyebrow="The work" title={`${projects.length} projects. One operating pattern.`} deck="Start with the eight feature cases or filter by the capability you need. Every project keeps its exact role, evidence status and publication boundary." aside={<div className="page-aside-stat"><strong>{String(featureProjects.length).padStart(2, "0")}</strong><span>feature cases</span><strong>{String(supportingCount).padStart(2, "0")}</strong><span>supporting cases</span></div>} />
